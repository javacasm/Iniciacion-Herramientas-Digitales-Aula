...
- **Text to Image (Dream Lab)**: Genera imágenes a partir de prompts de texto. *Ej.: "Un gato astronauta en Marte"*.  
  **Paso a paso**: 
	1. Abre un diseño nuevo. 
	2. Ve a "Apps" > "Magic Studio" > "Text to Image". 
	3. Escribe el prompt y selecciona estilo (realista, cartoon). 
	4. Genera y arrastra a tu canvas. *Nuevo en 2025: Soporte para estilos 3D y transiciones (cartoon a realista).*
	
- **Text to Graphic**: Crea iconos, stickers o ilustraciones. *Ej.: "Gráfico de pastel colorido para ventas"*.    **Paso a paso**: Similar a arriba, pero selecciona "Graphics" en Magic Media.
...
- **Magic Edit**: Edita partes específicas con prompts. *Ej.: Cambia un sombrero por una corona*.  
  **Paso a paso**: 
	1. Sube foto. 
	2. Selecciona área con pincel. 
	3. Escribe cambio (ej. "Añade flores"). 
	4. Aplica.
...
- **Limitaciones comunes**: Prompts en inglés dan mejores resultados; edita manualmente con precisión. En móvil, algunas (ej. Code) son web-only.
...
- **Edición**: Reescribir, acortar, expandir o ajustar el tono (ej. formal, juguetón).
...
##### a. **Generar Texto Nuevo desde un Prompt**
   ...
   5. Revisa las opciones (hasta 3 variantes). Arrastra la que te guste a canva o edítala directamente.
...
##### b. **Reescribir Texto Existente**
   ...
   3. Elige una acción predefinida:
      ...
      - **Acortar**: Reduce longitud sin perder la esencia.
...
Magic Write es accesible en todos los planes, pero con límites de queries mensuales (resetean cada mes). Los  planes de pagos incluyen más usos y funciones premium.
...
- **Presentaciones y vídeos**: Estructuras automáticas con contenido sugerido.
...
**Novedades en 2025**: Voice-to-Design (habla tu idea en la app móvil), Magic Collaboration (comentarios IA de equipo) y generación de vídeos con Beat Sync automático (sincroniza música con escenas). Todo con énfasis en privacidad: Canva no usa tus creaciones para entrenar IA.
...
**Ejemplo práctico**: Prompt: "Tarjeta de cumpleaños colorida para niño de 5 años". Resultado: Plantillas con globos, texto editable y espacio para fotos.
...
- **Disponibilidad**: No en templates muy antiguos; actualiza diseños. En Education, Vídeo solo para teachers.
