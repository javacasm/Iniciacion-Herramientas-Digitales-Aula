## Creación de imágenes con Google Nano Banana
![](./images/6.2.Nanobanana_logo.png)
...
![](./images/6.2.NanoBanana_anotated.png)
...
![](./images/6.2.Nanobanana_how_works.png)
...
![](./images/./images/5.2.NanoBanana_celula.png)
...
![](./images/./images/5.2.NanoBanana_volcan.png)
---
...
| Economía                | "Genera un gráfico de velas (candlestick chart) que ilustre una tendencia bajista (bear market) en el mercado de valores, con colores de contraste dramáticos (rojo y verde). El ambiente debe ser tenso y fotorrealista, como una sala de operaciones oscura."           | Visualizar representaciones de datos financieros complejas y sus atmósferas asociadas. |

![](./images/./images/6.2.Nano_banana_plano.png)


### **Consejo Clave para Uso Educativo:**

Para maximizar el valor educativo, pide siempre a la IA que **etiquete** los componentes clave de la imagen. Por ejemplo: "_Crea un diagrama del ciclo del agua y etiqueta: Evaporación, Condensación, Precipitación y Colección_". Esto convierte la imagen de una mera ilustración en una **herramienta de aprendizaje activa**.

### Algunos ejemplos reales

Internet ha explotado con la nueva versión de Gemini y de Nano Banana. Aquí algunos ejemplos con sus prompts 

![](./images/./images/6.2.NanoBanana_receta.png)
...
![](./images/6.2.Nanobanana_videojuego.png)
Incluso los fotogramas (sprites) de las animaciones de los personajes de un videojuego.

![](./images/6.2.Nanobanana_sprete.png)
...
![](./images/6.2.NanoBanana_reptil_sprite.png)

Si le pedimos que resuelva la operación escrita a mano... lo hace ¡incluso imita nuestra letra!

![](./images/6.2.Nanobanana_formula.png)

Me encantan las vistas de aparatos desmontados y anotadas con los detalles

![](./images/6.2.NanoBanana_exploded_views.png)

```prompt
Create a technical exploded view diagram of a [SUBJECT] in 1080x1080 dimension. The device is deconstructed showing all individual components floating in space, separated from each other to reveal internal parts. Each major component is labeled with clean lines pointing to parts like screen, circuit board, battery, casing, buttons, etc. Isometric perspective, technical illustration style with soft shadows between parts. Light grey/white clean background. Educational infographic aesthetic similar to engineering blueprints or patent drawings. All parts aligned in logical assembly order showing how they fit together
```